const Meta = () => {
  return (
    <>
      ...
      <meta name="title" content="Charles Boshell.C.Y : Portfolio" />
      <meta
        name="description"
...
production-ready software"
      ...
      <meta property="og:site_name" content="Charles Boshell.C.Y" />
      <meta property="og:title" content="Charles Boshell.C.Y | Portfolio" />
      <meta
